...
public class WeakKeyValueTableTest extends WeakTableTest {
    ...
    public void testWeakKeysValuesTable() {
        ...
        final WeakReference<LuaValue> origkey2 = new WeakReference<>(key2);
        final WeakReference<LuaValue> origval2 = new WeakReference<>(val2);
        final WeakReference<LuaValue> origkey3 = new WeakReference<>(key3);
        final WeakReference<LuaValue> origval3 = new WeakReference<>(val3);
