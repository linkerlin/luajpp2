...
assert(io.read(6, '*l') == '"álo"') -- CHANGED for luajpp2 - we use UTF-8, which is requires multiple bytes for the á character
assert(io.read(0) == "")
...
assert(io.read(2) == "ç") -- CHANGED for luajpp2 - we use UTF-8, which is requires multiple bytes for the ç character
